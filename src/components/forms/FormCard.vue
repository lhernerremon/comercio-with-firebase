  ...
  <div class="card-form">
    <div class="card-list d-flex flex-column">
      <VuePaycard
        ...
        :has-random-backgrounds="hasRandomBackgrounds"
        ...
        <div class="card-form__row">
          <div class="card-form__col">
            <div class="card-form__group">
              <label for="cardMonth" class="card-input__label" aria-label="Expiration Date">Fecha de expiración</label>
              <select
...
export default {
  ...
  methods: {
    emmitValues () {
      this.$emit('datos-tarjeta', this.valueFields)
    },
    changeName (e) {
